...
function Contact() {
  ...
  return (
    ...
    overflow-hidden' id='Contact'>
      ...
      <p className='text-center text-black mb-12 max-w-80 mx-auto'>Want to add your buisness ?
        or hire us to build your website ?
        ...
        <form onSubmit={onSubmit} className='max-w-2xl mx-auto to-black'>
            ...
            <button className='bg-black text-white py-2 px-12 mb-10 rounded hover:bg-gray-800'
