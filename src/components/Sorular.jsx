...
function Sorular() {
  return (
    ...
    w-full overflow-hidden mb-10 bg-slate-900"
        ...
        <Accordion title='ما هو ايميل و رقم شؤون الطلبة في الجامعة؟' answer='0326 310 1011' linktext='ogrenci@iste.edu.tr'/>
        ...
        <Accordion title='من أين يمكنني رؤية الصيدليات المناوبة؟' link='https://www.eczaneler.gen.tr/nobetci-hatay-iskenderun' linktext='في الرابط هذا'/>
